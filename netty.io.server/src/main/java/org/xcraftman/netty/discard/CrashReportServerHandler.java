 ...
 * under the License.
 */
package org.xcraftman.netty.discard;
...
public class CrashReportServerHandler extends SimpleChannelInboundHandler<HttpObject> {

    private static final Logger logger = Logger.getLogger(CrashReportServerHandler.class.getName());
